...
export const CasanobreeLogo: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" fill="none" stroke="currentColor" className={className}>
    {/* Círculo Externo */}
    <circle cx="50" cy="50" r="44" strokeWidth="4" />
    
    {/* Torre Direita (Maior) */}
    <path d="M53 78 V 24 L 66 16 V 78 H 53 Z" strokeWidth="3" strokeLinejoin="round" />
    
    {/* Torre Esquerda (Menor) */}
    <path d="M34 78 V 40 L 47 32 V 78 H 34 Z" strokeWidth="3" strokeLinejoin="round" />
  </svg>
);

// Mantendo HomeIcon para compatibilidade caso necessário
